  ...
  return (
    <main>
      <div className="flex flex-col gap-5 items-center justify-between py-6">
        <h1 className="lg:text-[4rem] text-[2.1rem] text-center mt-10 font-bold text-violet-600">
          Wellcome To Home
        </h1>
        <button
        ...
        >
          <span className="text-xl font-bold font-[poppins] relative px-3 py-1 transition-all ease-in duration-75 bg-white dark:bg-gray-900 rounded-md group-hover:bg-opacity-0">
            Go to About
          </span>
        </button>
      </div>
